...
#class fro each block determining the characters in the block
class Block:
    x = 0
    y = 0
    n = 0
...
pygame.display.set_caption("polite tyrant")
run = True
while run:
    screen.fill((16, 57, 34 ))
    font = pygame.font.SysFont("Calibri", 70, bold=True)
    label = font.render("mumu start game!", True, '#FFFFFF')
